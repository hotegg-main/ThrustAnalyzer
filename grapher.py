...
def plot_thrust_curve(path, time_raw, thrust_raw, time, thrust, info_thrust, tan1, tan2, nor):
    ...
    plt.axvline(info_thrust['Burnout Time, Time'], linestyle='--', color='aqua')
    plt.axvline(info_thrust['Act. End Time'], linestyle='--', color='aqua')
    plt.axhline(info_thrust['Max Thrust'], linestyle='--', color='gold')
    plt.axhline(info_thrust['Ave. Thrust(Act)'], linestyle='--', color='gold')
    plt.axhline(info_thrust['Ave. Thrust(Burn)'], linestyle='--', color='gold')
    plt.text(info_thrust['Burnout Time, Time'], .0  , 'Burn. Time'          , color='aqua', rotation=90., verticalalignment='bottom', horizontalalignment='right')
    plt.text(info_thrust['Act. End Time'], .0      , 'Act. Time'           , color='aqua', rotation=90., verticalalignment='bottom', horizontalalignment='right')
    plt.text(.2, info_thrust['Max Thrust']          , 'Max. Thrust'         , color='gold', rotation=0., verticalalignment='top', horizontalalignment='left')
    plt.text(.2, info_thrust['Ave. Thrust(Act)']    , 'Ave. Thrust(Act)'    , color='gold', rotation=0., verticalalignment='top', horizontalalignment='left')
    plt.text(.2, info_thrust['Ave. Thrust(Burn)']   , 'Ave. Thrust(Burn)'   , color='gold', rotation=0., verticalalignment='top', horizontalalignment='left')
